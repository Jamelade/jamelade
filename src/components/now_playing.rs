...
pub struct Snapshot {
    ...
    pub queue_open: bool,
    /// The lyrics page is already open. Its shortcut then stands down instead
    /// of placing two nearly identical list icons in the densest part of the
    /// bar for an action that cannot navigate anywhere new.
        ...
        gtk::Box {
            ...
            gtk::Box {
                ...
                gtk::Button {
                    ...
                    set_sensitive: model.snap.active,
                    #[watch]
                    set_visible: !model.snap.lyrics_open,
                    connect_clicked => NowPlayingInput::ShowLyrics,
                },
