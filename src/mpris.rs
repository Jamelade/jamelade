...
//!
//! Exposes `org.mpris.MediaPlayer2.Jamelade` so desktop media controls,
...
//!
//! ARCHITECTURE.md says reaching for `Rc<RefCell<>>` usually means state belongs in a
...
fn track_id(id: Option<&str>) -> Option<TrackId> {
    ...
    TrackId::try_from(format!("/io/github/Jamelade/Jamelade/track/{safe}")).ok()
}
    ...
    pub fn start(sender: ComponentSender<AppModel>) -> Self {
        ...
        relm4::spawn_local(async move {
            let player = match Player::builder(crate::MPRIS_BUS_SUFFIX)
                ...
                // still-playing Jamelade holding the sidecar open. Without
...
mod tests {
    ...
    fn track_ids_are_valid_object_paths() {
        ...
        assert_eq!(id.as_str(), "/io/github/Jamelade/Jamelade/track/1049009209");
    }
    ...
    fn library_ids_with_illegal_characters_are_sanitised() {
        ...
        assert_eq!(id.as_str(), "/io/github/Jamelade/Jamelade/track/i_AbCd_123");
    }
    ...
    fn art_url_is_a_file_uri() {
        let state = MprisState {
            art_path: Some(PathBuf::from("/home/x/.cache/jamelade/artwork/ab-512.jpg")),
            ..Default::default()
        };
