...
impl View {
    ...
    /// Whether this section uses the header's search field.
    pub(super) fn searchable(self) -> bool {
        !matches!(self, Self::Explore | Self::Lyrics)
    }

    /// Whether the header can refresh this section.
    pub(super) fn reloadable(self) -> bool {
        !matches!(self, Self::Search | Self::Lyrics)
    }

    /// Whether the visible contents have a local sort order.
    pub(super) fn sortable(self) -> bool {
        matches!(
            self,
            Self::Songs | Self::Albums | Self::Artists | Self::Playlists
        )
    }
...
impl From<Section> for View {
    fn from(section: Section) -> Self {
        match section {
            Section::Explore => Self::Explore,
            Section::Lyrics => Self::Lyrics,
...
impl From<View> for Section {
    fn from(view: View) -> Self {
        match view {
            View::Explore => Self::Explore,
            View::Lyrics => Self::Lyrics,
...
impl SortBy {
    ...
    pub(super) fn for_view(view: View) -> &'static [Self] {
        match view {
            ...
            View::Explore | View::Lyrics => &[Self::Title],
        }
    }
...
impl Sorts {
    ...
    pub(super) fn get(&self, view: View) -> Sort {
        match view {
            ...
            View::Explore | View::Lyrics => self.songs,
        }
    }
    ...
    pub(super) fn set(&mut self, view: View, sort: Sort) {
        let slot = match view {
            ...
            View::Explore | View::Lyrics => &mut self.songs,
        };
        *slot = sort;
    }
}
