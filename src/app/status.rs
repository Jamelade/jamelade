...
impl AppModel {
    ...
    pub(super) fn showing_library(&self) -> bool {
        ...
        match self.view {
            View::Explore | View::Lyrics => matches!(self.stage, Stage::Ready),
    ...
    pub(super) fn search_showing(&self) -> bool {
        self.view.searchable() && (!self.narrow_header || self.searching)
    }
    ...
    pub(super) fn loading_in(&self, view: View) -> bool {
        match view {
            View::Explore => self.loading_explore,
            View::Lyrics => self.lyrics_loading,
    ...
    pub(super) fn waiting_for(&self) -> String {
        ...
        match self.view {
            View::Explore => "Loading your Apple Music recommendations",
            View::Lyrics => "Finding lyrics",
    ...
    pub(super) fn page(&self) -> &'static str {
        ...
        match self.view {
            // These own their internal loading, empty and error states. A
            // refresh therefore never swaps the whole pane away from someone
            // already reading it.
    ...
    pub(super) fn headline(&self) -> String {
        match &self.stage {
            ...
            Stage::SignedOut => "Welcome to Jamelade".into(),
    ...
    pub(super) fn detail(&self) -> String {
        match &self.stage {
            ...
            Stage::SignedOut => "Jamelade plays your Apple Music library as a native Linux app. \
